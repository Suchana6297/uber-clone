...
const Start = () => {
  return (
    <div>
      <div className="bg-cover bg-center bg-[url(https://img.freepik.com/premium-photo/cinematic-photo-traffic-lights_1108533-49535.jpg?semt=ais_hybrid)] h-screen pt-8 flex justify-between flex-col w-full">
        <img
          className="w-16 ml-8"
